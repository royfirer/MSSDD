# MSSDD
Marble Slab Surface Defect Detection(MSSDD), a multi-resolution dataset specifically designed for few-shot defect detection and segmentation in marble slab surfaces.
